/// @description Checks if Left Horizontal analog stick was just RELEASED
/// @functon analogLeftHorizontalRelease
...
if (instance_number(obj_controlsAnalog) > 0) {
  if (os_type == os_android) {
    switch (slot) {
      case 1:
        if (obj_controlsAnalog.p1_lh_release) {
          return true;
        }
        break;
      case 2:
        if (obj_controlsAnalog.p2_lh_release) {
          return true;
        }
        break;
      case 3:
        if (obj_controlsAnalog.p3_lh_release) {
          return true;
        }
        break;
      case 4:
        if (obj_controlsAnalog.p4_lh_release) {
          return true;
        }
        break;
    }
