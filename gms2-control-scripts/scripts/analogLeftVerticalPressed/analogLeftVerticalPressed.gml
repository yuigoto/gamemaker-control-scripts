/// @description Checks if Left Vertical analog stick was just PRESSED
/// @functon analogLeftVerticalPressed
...
if (instance_number(obj_controlsAnalog) > 0) {
  if (os_type == os_android) {
    switch (slot) {
      case 1:
        if (obj_controlsAnalog.p1_lv_pressed) {
          return true;
        }
        break;
      case 2:
        if (obj_controlsAnalog.p2_lv_pressed) {
          return true;
        }
        break;
      case 3:
        if (obj_controlsAnalog.p3_lv_pressed) {
          return true;
        }
        break;
      case 4:
        if (obj_controlsAnalog.p4_lv_pressed) {
          return true;
        }
        break;
    }
