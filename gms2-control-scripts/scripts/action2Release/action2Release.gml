/// @description Checks if input for "ACTION 2" was just RELEASED
...
if (os_type == os_android) {
  switch(slot) {
    case 1:
      button  = global.P1_PAD_ACTION2;
      key     = global.P1_KEY_ACTION2;
      break;
    case 2:
      button  = global.P2_PAD_ACTION2;
      key     = global.P2_KEY_ACTION2;
      break;
    case 3:
      button  = global.P3_PAD_ACTION2;
      key     = global.P3_KEY_ACTION2;
      break;
    case 4:
      button  = global.P4_PAD_ACTION2;
