/// @description Bootstraps controller-related globals for up to 4 players
/// @function controlsInit
/// @param {bool} use_analog Optional, when defined as `true`, creates an analog input watcher object, for the analog input status emulator scripts
...
if (use_analog && instance_number(obj_controlsAnalog) < 1) {
  instance_create_depth(0, 0, 999, obj_controlsAnalog);
}
