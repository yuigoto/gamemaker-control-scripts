/// @description  action5Release(slot)
/// @function  action5Release
/// @param slot

/**
 * Checks if the gamepad/key input for "ACTION 5" was just released on the
 * keyboard or gamepad.
 *
...
if (os_type == os_android) {
    switch (slot) {
        // PLAYER 1
        case 1:
            btn = global.P1_PAD_ACTION5;
            key = global.P1_KEY_ACTION5;
            break;
        // PLAYER 2
        case 2:
            btn = global.P2_PAD_ACTION5;
            key = global.P2_KEY_ACTION5;
            break;
        // PLAYER 3
        case 3:
            btn = global.P3_PAD_ACTION5;
            key = global.P3_KEY_ACTION5;
            break;
        // PLAYER 4
        case 4:
            btn = global.P4_PAD_ACTION5;
            key = global.P4_KEY_ACTION5;
            break;
    }
} else {
    switch (slot) {
