/// @description Checks if input for "ACTION 4" was just released
...
if (os_type == os_android) {
    switch (slot) {
        // PLAYER 1
        case 1:
            button  = global.P1_PAD_ACTION4;
            key     = global.P1_KEY_ACTION4;
            break;
        // PLAYER 2
        case 2:
            button  = global.P2_PAD_ACTION4;
            key     = global.P2_KEY_ACTION4;
            break;
        // PLAYER 3
        case 3:
            button  = global.P3_PAD_ACTION4;
            key     = global.P3_KEY_ACTION4;
            break;
        // PLAYER 4
        case 4:
            button  = global.P4_PAD_ACTION4;
