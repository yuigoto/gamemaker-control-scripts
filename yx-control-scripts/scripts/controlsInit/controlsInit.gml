/// @description Bootstraps all the controler-related globals
/// @function controlsInit 
/// @param {boolean} use_analog Optional, if using analog controls or not
...
if (use_analog && instance_number(obj_controlsAnalog) < 1) {
    instance_create_depth(0, 0, 0, obj_controlsAnalog);
}
