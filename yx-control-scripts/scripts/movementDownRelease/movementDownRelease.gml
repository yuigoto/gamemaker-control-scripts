/// @description  movementDownRelease(slot)
/// @function  movementDownRelease
/// @param slot

/**
 * Checks if the gamepad/key input for "DOWN" was just released on the
 * keyboard or gamepad.
 *
...
if (os_type == os_android) {
    switch (slot) {
        // PLAYER 1
        case 1:
            btn = global.P1_PAD_DN;
            key = global.P1_KEY_DN;
            axl = global.P1_ANALOG_LV;
            break;
        // PLAYER 2
        case 2:
            btn = global.P2_PAD_DN;
            key = global.P2_KEY_DN;
            axl = global.P2_ANALOG_LV;
            break;
        // PLAYER 3
        case 3:
            btn = global.P3_PAD_DN;
            key = global.P3_KEY_DN;
            axl = global.P3_ANALOG_LV;
            break;
        // PLAYER 4
        case 4:
            btn = global.P4_PAD_DN;
            key = global.P4_KEY_DN;
