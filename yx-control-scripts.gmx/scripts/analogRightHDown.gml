/// @description Checks if analog stick Right Horizontal is DOWN
/// @function analogRightHDown
...
if (instance_number(obj_controlsAnalog) > 0) {
    ...
    if (os_type == os_android) {
        switch (slot) {
            // PLAYER 1
            case 1: 
                if (obj_controlsAnalog.p1_rh_down) return true;
                break;
            // PLAYER 2
            case 2: 
                if (obj_controlsAnalog.p2_rh_down) return true;
                break;
            // PLAYER 3
            case 3: 
                if (obj_controlsAnalog.p3_rh_down) return true;
                break;
            // PLAYER 4
            case 4: 
                if (obj_controlsAnalog.p4_rh_down) return true;
                break;
        }
    } else {
        switch (slot) {
