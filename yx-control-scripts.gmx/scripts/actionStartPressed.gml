/// actionStartPressed(slot)

/**
 * Checks if the gamepad/key input for "START" was just pressed on the
 * keyboard or gamepad.
 *
...
if (os_type == os_android) {
    switch (slot) {
        // PLAYER 1
        case 1:
            button  = global.P1_PAD_START;
            key     = global.P1_KEY_START;
            break;
        // PLAYER 2
        case 2:
            button  = global.P2_PAD_START;
            key     = global.P2_KEY_START;
            break;
        // PLAYER 3
        case 3:
            button  = global.P3_PAD_START;
            key     = global.P3_KEY_START;
            break;
        // PLAYER 4
        case 4:
            button  = global.P4_PAD_START;
